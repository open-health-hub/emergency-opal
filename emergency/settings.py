...
SECRET_KEY = '2a(+9n=1p_ed$6i8+bovdhl68=)=)e$$oiy@op873h66j9*fce'
...
COVERAGE_EXCLUDE_MODULES = ('emergency.migrations', 'emergency.tests',
                            'emergency.local_settings',
